<?php include "includes/headeroutside.php"; ?>
...
<div class="collapse navbar-collapse" id="navbar-collapse-1">
    <ul class="nav navbar-nav">
          	<li><a href="keynotes2.php#hayes" class="center">Dr. Heidi Hayes Jacobs:<br>June 17th</a></li>
          	<li><a href="keynotes2.php#casap" class="center">Jaime Casap:<br>June 18th</a></li>
          	<li><a href="keynotes2.php#burmark" class="center">Dr. Lynell Burmark:<br>June 19th</a></li>
          	<li><a href="keynotes2.php#flood" class="center">Dr. Tim Flood:<br>June 24th</a></li>
    </ul>

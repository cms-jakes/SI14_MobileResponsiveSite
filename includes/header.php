    ...
    <!-- Collect the nav links, forms, and other content for toggling -->
     <div class="collapse navbar-collapse" id="navbar-collapse-1">
      <ul class="nav navbar-nav">
   		<li><a href="index.php">SI14 <span class="glyphicon glyphicon-home"></span></a></li>
        ...
        <li class="dropdown">
          <a href="#" class="nav dropdown-toggle" data-toggle="dropdown">Information<b class="caret"></b></a>
          <ul class="dropdown-menu">

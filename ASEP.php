...
<!--ASEP -->
<div class="blue">
	<section class="container"> <!--Title info-->
		<div class="center">
			<h2>Free childcare for children of CMS teachers <strong>attending</strong> Summer Institute</h2>
			<h4><i>First 100 children registered per day are free</i><h4>
		</div>
		<div>
...
<br>
			<ul><h2>More Details</h2>
				<li><h4>Location: 1st Ward Elementary School <br> 
					<a href="https://www.google.com/maps/preview?safe=active&ie=UTF-8&q=First+Ward+Elementary+School&fb=1&gl=us&hq=first+ward+elementary+school+charlotte+nc&cid=17426285524396765471&ei=l5xSU6HvOIqu8AH724CYBg&ved=0CIgBEPwSMAs" target="blank">
				...
				<li><h4>Registration closes June 6th</h4></li>
